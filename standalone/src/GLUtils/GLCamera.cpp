...
void GLCamera::applyCameraTransformations(){
	...
	Vector3d _001 = Vector3d(0, 0, 1);
	Vector3d _010 = Vector3d(0, 1, 0);
	Vector3d _100 = Vector3d(1, 0, 0);
	orientation = Quaternion::getRotationQuaternion(rotations.z, _001)
				* Quaternion::getRotationQuaternion(rotations.y, _010)
				* Quaternion::getRotationQuaternion(rotations.x, _100);
